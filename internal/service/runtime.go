...
var Connectors = map[string]Connector{
	...
	"legado-hub":     {Name: "LegadoHub", StatusPath: "/api/auth/entrypoint", StatePath: "/api/auth/entrypoint", RequiredKey: "entrypoint", Protocols: []string{"legado-hub", "legado-book"}, MediaTypes: []string{"text.novel"}, Capabilities: []string{"search", "detail", "chapter", "progress"}, ProbeLevel: "service"},
